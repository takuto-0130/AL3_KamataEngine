...
public:
	...
	void Update(Player* player, const std::list<Enemy*> enemys, const std::list<EnemyBullet*> enemyBullets);

private:

	void ColliderListRegistration(Player* player, const std::list<Enemy*> enemys, const std::list<EnemyBullet*> enemyBullets);
