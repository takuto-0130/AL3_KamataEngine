...
void ColliderManager::Update(Player* player, const std::list<Enemy*> enemys, const std::list<EnemyBullet*> enemyBullets) { 
	ColliderListClear();
	ColliderListRegistration(player, enemys, enemyBullets);
	CheckAllCollisions();
}

void ColliderManager::ColliderListRegistration(Player* player, const std::list<Enemy*> enemys, const std::list<EnemyBullet*> enemyBullets) {
